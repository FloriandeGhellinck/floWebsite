          ...
          <div className='flex flex-col text-justify m-5'>
            <div className='m-1 text-black '>
              <p>
                ...
                fun at Embie. This project has been created to keep track of our
                scores when we play pool during lunch time.
              </p>{' '}
              <br />
              <p>
                Click{' '}
              ...
              <p>
                This projects was the opportunity to train my Tailwind skills. I
                totally agree that the design isn't beautiful, but I had the
                ...
                <br /> <br />I had to develop a small backend in order to let
                people login in the app to enter their scores. It's just a call
                to the database in order to compare the passwords and allow
                access or not.
                <br /> <br />A database has been created for this project. This
                database has been constructed to create user's profiles and to
                manage their participations to games.
                <br /> <br /> This project has been very interesting to
                understand much better how all of this works together.
              </p>
            </div>
          </div>
        </div>
