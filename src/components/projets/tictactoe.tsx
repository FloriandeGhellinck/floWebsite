...
const TicTacToeProject = () => {
  ...
  return (
    <>
      <Card>
        <AboutTitle title="TicTacToe" />
        <div className="font-poppins">
          <div className="flex flex-col text-justify m-5">
            <div className="m-1 text-black ">
              <p>
                TicTacToe Project is a personal project developped to reinforce my coding skills. I wanted to code a game with a grid. I
                developed this to test my logical skills with the grid and how to handle it.
              </p>{" "}
              <br />
              <p>
                Click{" "}
                <a href="https://tic-tac-toe-floriandeghellinck.vercel.app/" target="_blank" className="font-bold">
                  {" "}
                  HERE
                </a>{" "}
                to check it out.
              ...
              <p>
                This projects was the opportunity to train my Tailwind skills on grids. I also had to add all the logic to check out if
                someone won a game. I did this project based on a video on YouTube. It was a great project to work on, even of the logical
                part isn't coming from me.
              </p>
            </div>
          </div>
        </div>
