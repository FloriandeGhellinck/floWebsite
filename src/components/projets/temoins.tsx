        ...
        <div className="font-poppins">
          <div className="flex flex-col text-justify m-5">
            <div className="m-1 text-black ">
              ...
              <p>
                Click{" "}
                <a href="https://quiz-flo.vercel.app/" target="_blank" className="font-bold">
                  {" "}
                  HERE
                </a>{" "}
                to check it out.
              ...
              <br />
              <p>I added a hidden class on big screens. This website is only visible on phone screens.</p>
              ...
              <p>
                This projects was a very small project developed in one day. It's certainly not a big project, but it was really cool to be
                able to develop a personal project in less than a day. This project was the opportunity to focus on creating reusable
                components, play with the states and hooks from React (to calculate the scores).
              </p>
            </div>
          </div>
        </div>
