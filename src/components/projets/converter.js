          ...
          <div className='flex flex-col text-justify m-5'>
            <div className='m-1 text-black '>
              <p>
                ...
                used internally and has been created to convert data for one of
                Embie's customer.
              </p>{' '}
              <br />
              <p>
              ...
              <p>
                This was my first project at Embie. I had never use Tailwind
                before this project. I created a black and white theme in order
                to start playing with libraries. It was a first great single
                page project to learn how things work together (React).
              </p>
            </div>
          </div>
        </div>
