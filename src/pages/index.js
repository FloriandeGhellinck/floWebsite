...
export default function Home({}) {
  ...
  return (
    <>
      <Navbar handleClickScroll={handleClickScroll} setOpenModal={setOpenModal} openModal={openModal}>
        <main>
          <WelcomePage />
          <About aboutMeSectionRef={aboutMeSectionRef} setOpenModal={setOpenModal} />
        </main>
      </Navbar>
      <footer>
        <FooterSection />
